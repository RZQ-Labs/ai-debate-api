...
Revision ID: 3d9c91b52240
Revises: 
Create Date: 2025-04-26 04:37:57.586812
...
def upgrade() -> None:
    ...
    op.drop_index('IDX_9ec1ce6fbf82305f489adb971d', table_name='test_definition')
    op.drop_index('IDX_b0dd0087fe3da02b0ffa4b9c5b', table_name='test_definition')
    op.drop_index('pk_test_definition_id', table_name='test_definition')
    ...
    op.drop_index('IDX_3a4e9cf37111ac3270e2469b47', table_name='test_metric')
    op.drop_table('test_metric')
    ...
    op.drop_index('IDX_3a81713a76f2295b12b46cdfca', table_name='test_run')
...
def downgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id', name='PK_e853ce24e8200abe5721d2c6ac552b73'),
    sa.UniqueConstraint('scope', 'name', name='UQ_5b49d0f504f7ef31045a1fb2eb8')
    )
    ...
    op.create_index('pk_variables_id', 'variables', ['id'], unique=True)
    ...
    op.create_index('IDX_14f68deffaf858465715995508', 'folder', ['projectId', 'id'], unique=True)
    ...
    op.create_index('IDX_97f863fa83c4786f1956508496', 'execution_annotations', ['executionId'], unique=True)
    ...
    sa.Column('id', sa.VARCHAR(length=36), autoincrement=False, nullable=False),
    sa.Column('testDefinitionId', sa.VARCHAR(length=36), autoincrement=False, nullable=False),
    sa.Column('status', sa.VARCHAR(), autoincrement=False, nullable=False),
    ...
    op.create_index('IDX_1d8ab99d5861c9388d2dc1cf73', 'insights_metadata', ['workflowId'], unique=True)
    ...
    op.create_index('pk_workflow_entity_id', 'workflow_entity', ['id'], unique=True)
    ...
    op.create_index('IDX_cec8eea3bf49551482ccb4933e', 'execution_metadata', ['executionId', 'key'], unique=True)
    ...
    op.create_table('test_metric',
    sa.Column('id', sa.VARCHAR(length=36), autoincrement=False, nullable=False),
    sa.Column('name', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('testDefinitionId', sa.VARCHAR(length=36), autoincrement=False, nullable=False),
    sa.Column('createdAt', postgresql.TIMESTAMP(timezone=True, precision=3), server_default=sa.text('CURRENT_TIMESTAMP(3)'), autoincrement=False, nullable=False),
    sa.Column('updatedAt', postgresql.TIMESTAMP(timezone=True, precision=3), server_default=sa.text('CURRENT_TIMESTAMP(3)'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['testDefinitionId'], ['test_definition.id'], name='FK_3a4e9cf37111ac3270e2469b475', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='PK_3e98b8e20acc19c5030a8644142')
    )
    op.create_index('IDX_3a4e9cf37111ac3270e2469b47', 'test_metric', ['testDefinitionId'], unique=False)
    ...
    op.create_index('IDX_ae51b54c4bb430cf92f48b623f', 'annotation_tag_entity', ['name'], unique=True)
    op.create_table('test_definition',
    sa.Column('name', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('workflowId', sa.VARCHAR(length=36), autoincrement=False, nullable=False),
    sa.Column('evaluationWorkflowId', sa.VARCHAR(length=36), autoincrement=False, nullable=True),
    sa.Column('annotationTagId', sa.VARCHAR(length=16), autoincrement=False, nullable=True),
    sa.Column('createdAt', postgresql.TIMESTAMP(timezone=True, precision=3), server_default=sa.text('CURRENT_TIMESTAMP(3)'), autoincrement=False, nullable=False),
    sa.Column('updatedAt', postgresql.TIMESTAMP(timezone=True, precision=3), server_default=sa.text('CURRENT_TIMESTAMP(3)'), autoincrement=False, nullable=False),
    sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('id', sa.VARCHAR(length=36), autoincrement=False, nullable=False),
    sa.Column('mockedNodes', postgresql.JSON(astext_type=sa.Text()), server_default=sa.text("'[]'::json"), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['annotationTagId'], ['annotation_tag_entity.id'], name='FK_d5d7ea64662dbc62f5e266fbeb0', ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['evaluationWorkflowId'], ['workflow_entity.id'], name='FK_9ec1ce6fbf82305f489adb971d3', ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['workflowId'], ['workflow_entity.id'], name='FK_b0dd0087fe3da02b0ffa4b9c5bb', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='test_definition_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_index('pk_test_definition_id', 'test_definition', ['id'], unique=True)
    op.create_index('IDX_b0dd0087fe3da02b0ffa4b9c5b', 'test_definition', ['workflowId'], unique=False)
    op.create_index('IDX_9ec1ce6fbf82305f489adb971d', 'test_definition', ['evaluationWorkflowId'], unique=False)
    ...
    op.create_index('IDX_63d7bbae72c767cf162d459fcc', 'user_api_keys', ['userId', 'label'], unique=True)
    op.create_index('IDX_1ef35bac35d20bdae979d917a3', 'user_api_keys', ['apiKey'], unique=True)
    ...
    sa.Column('pastExecutionId', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('executionId', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('evaluationExecutionId', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('status', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('runAt', postgresql.TIMESTAMP(timezone=True, precision=3), autoincrement=False, nullable=True),
    sa.Column('completedAt', postgresql.TIMESTAMP(timezone=True, precision=3), autoincrement=False, nullable=True),
    ...
    sa.Column('createdAt', postgresql.TIMESTAMP(timezone=True, precision=3), server_default=sa.text('CURRENT_TIMESTAMP(3)'), autoincrement=False, nullable=False),
    sa.Column('updatedAt', postgresql.TIMESTAMP(timezone=True, precision=3), server_default=sa.text('CURRENT_TIMESTAMP(3)'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['evaluationExecutionId'], ['execution_entity.id'], name='FK_dfbe194e3ebdfe49a87bc4692ca', ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['executionId'], ['execution_entity.id'], name='FK_e48965fac35d0f5b9e7f51d8c44', ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['pastExecutionId'], ['execution_entity.id'], name='FK_258d954733841d51edd826a562b', ondelete='SET NULL'),
    ...
    op.create_index('pk_tag_entity_id', 'tag_entity', ['id'], unique=True)
    op.create_index('idx_812eb05f7451ca757fb98444ce', 'tag_entity', ['name'], unique=True)
    ...
    op.create_index('pk_credentials_entity_id', 'credentials_entity', ['id'], unique=True)
    ...
    op.create_index('IDX_60b6a84299eeb3f671dfec7693', 'insights_by_period', ['periodStart', 'type', 'periodUnit', 'metaId'], unique=True)
